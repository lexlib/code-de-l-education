...
Le jury est nommé pour chaque session par le recteur d'académie. Il est présidé par celui-ci ou son représentant. Le
président du jury est assisté ou suppléé par un président adjoint choisi parmi les membres de la profession considérée.
...
Au vu des procès-verbaux des jurys, le recteur d'académie délivre le diplôme du brevet des métiers d'art. En cas d'erreur
